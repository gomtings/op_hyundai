...
def fill_pose_msg(msg: capnp._DynamicStructBuilder, net_output_data: dict[str, np.ndarray],
  ...
  if not msg.valid:
    print(f"[modeld_v2] cameraOdometry valid=False: live_calib_seen={live_calib_seen}, dropped_frames={vipc_dropped_frames}")
  elif not live_calib_seen:
    print(f"[modeld_v2] cameraOdometry PUBLISHING while uncalibrated (valid=True)")
