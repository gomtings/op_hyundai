...
const int HYUNDAI_PARAM_FCEV_GAS = 256;// ADD FCEV
...
bool hyundai_fcev_gas_signal = false;// ADD FCEV
...
void hyundai_common_init(uint16_t param) {
  ...
  hyundai_fcev_gas_signal = GET_FLAG(param, HYUNDAI_PARAM_FCEV_GAS); // ADD FCEV
